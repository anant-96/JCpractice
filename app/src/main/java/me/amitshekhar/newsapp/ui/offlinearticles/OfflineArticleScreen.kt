...
@Composable
fun OfflineArticleScreen(uiState: UiState<List<LocalArticle>>, onNewsClick: (url: String) -> Unit) {
    when (uiState) {
        is UiState.Success -> {
...
@Composable
fun ArticleList(articles: List<LocalArticle>, onNewsClick: (url: String) -> Unit) {
    LazyColumn {
...
@Composable
fun Article(article: LocalArticle, onNewsClick: (url: String) -> Unit) {
...
@Composable
fun BannerImage(article: LocalArticle) {
    AsyncImage(
...
@Composable
fun SourceText(source: LocalSource) {
    Text(
        text = source.name,
